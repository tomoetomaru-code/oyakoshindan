    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-4 py-16">
      ...
      <div className="card max-w-lg w-full p-8 md:p-12 text-center slide-up">
        ...
        <div className="flex justify-center gap-2 mb-6 flex-wrap">
          <span className="tag" style={{ background: "#FEF3DA", color: "#8B5E0A" }}>
            🌿 シュタイナー4気質
          </span>
          <span className="tag" style={{ background: "#E6F4F2", color: "#1A5C56" }}>
            🧠 MI理論
          </span>
          <span className="tag" style={{ background: "#F0ECF7", color: "#4E3580" }}>
            ☯ ユング理論
          </span>
        </div>
        ...
        >
          子どもと親それぞれの気質・知能の強み・エネルギーの向き方を診断します。
          <br />
          親子の個性の違いを理解し、子どもの才能を伸ばすための具体的なアドバイスをお届けします。
        </p>
        ...
        >
          <div>
            <div
              className="text-2xl font-bold font-mincho"
      ...
      <p className="mt-8 text-xs" style={{ color: "var(--text-muted)" }}>
        シュタイナー教育 × ハワード・ガードナーMI理論 × カール・ユング
      </p>
    </main>
  );
}
