...
export const childQuestions: Question[] = [
  ...
  {
    id: 4,
    text: "グループ遊びでは自然とリーダー的な役割になり、みんなを引っ張ろうとしますか？",
    framework: "steiner",
    dimension: "choleric",
    forWhom: "child",
  },
  ...
  {
    id: 13,
    text: "体を動かす遊びや手を使った工作など、動きながら学んだり遊ぶのが好きですか？",
    framework: "mi",
    dimension: "bodily",
    forWhom: "child",
  },
  {
    id: 14,
    text: "友達と一緒に遊ぶのが大好きで、相手の気持ちや雰囲気をよく読んでいますか？",
    framework: "mi",
  ...
  {
    id: 15,
    text: "自分の気持ちについてよく話したり、一人でじっくり考える時間を好みますか？",
    framework: "mi",
...
export const parentQuestions: Question[] = [
  ...
  {
    id: 2,
    text: "子どもが言うことを聞かないとき、つい声が大きくなったり強い言葉で言ってしまいますか？",
    framework: "steiner",
    dimension: "choleric",
    forWhom: "parent",
  },
  {
    id: 3,
    text: "「こうあるべき」という信念が強く、子どもにもそれを求めてしまうことがありますか？",
    framework: "steiner",
    dimension: "choleric",
    forWhom: "parent",
  },
  ...
  {
    id: 8,
    text: "物事を順序立てて考えたり、ルールや仕組みで整理するのが得意ですか？",
    framework: "mi",
    dimension: "logical",
    forWhom: "parent",
  },
